...
def deepL_image_generator(fetch_loss_and_grads):
    ...
    base_image_path = "local-filename.jpg"
...
if __name__ == "__main__":
    ...
    deepL_image_generator(fetch_loss_and_grads)
